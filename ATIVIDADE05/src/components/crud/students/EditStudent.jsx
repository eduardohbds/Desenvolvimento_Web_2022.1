...
//import { estudantes } from './data.js'
...
function EditStudent(props) {
    ...
    useEffect(
        () => {
            ...
            // axios.get('http://localhost:3002/estudantes/' + params.id)
            //     .then(
            //         (res) => {
            ...
            FirebaseService.retrieve_promisse(
                ...
                (estudante) => {
                    setName(estudante.name)
                    setCourse(estudante.course)
    ...
    const handleSubmit = (event) => {
        ...
        // axios.put('http://localhost:3002/estudantes/' + params.id, updatedStudent)
        //     .then(
        //         res => {
